...
check_button = st.button(label="CHECK", type="primary", use_container_width=True, disabled=st.session_state.q7_clicked, key='q7')
if check_button:
...
if check_button:
    if (option_chossen == None) or (option_chossen == []):
        ...
        if q["correct answer"] == ops[option_chossen]:
            ...
            if "q7_done" not in st.session_state:
